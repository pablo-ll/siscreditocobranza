                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                <div class="btn-group" usuario="group" aria-label="Basic example">
                                    <a href="{{url('/admin/usuarios',$usuario->id)}}" style="border-radius: 4px" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a>
                                    <a href="{{url('/admin/usuarios/'.$usuario->id.'/edit')}}" style="border-radius: 4px " class="btn btn-block bg-gradient-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>

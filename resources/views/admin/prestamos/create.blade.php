            ...
            <div class="col-md-12">
                <div class="card  card-primary">
                    ...
                    <div class="card-body" style="display: block;">
                        ...
                        <div class="row" id="contenido_cliente" style="display: none;">
                            <div class="col-md-12">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="nro_documento"name="nro_documento" placeholder="Escriba aqui..."
                                                    disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="nro_cuotas" value="8"
                                        name="nro_cuotas">
                                    @error('nro_cuotas')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="fecha_prestamo"
                                        value="{{ Carbon\Carbon::now()->format('Y-m-d') }}" name="fecha_inicio">
                                    @error('fecha_inicio')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                                </div>

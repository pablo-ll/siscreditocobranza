...
@section('content_header')
    <h1><b> Configuracion/Registro</b></h1>
    <hr>
@stop
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="nombre" placeholder="Escriba aqui...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="descripcion" placeholder="Escriba aqui...">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control"  name="direccion" placeholder="Escriba aqui...">
                                            </div>
                                            @error('direccion')
                                            <small style="color: red">{{$message}}</small>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="telefono" placeholder="Escriba aqui...">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="email" class="form-control" name="email" placeholder="Escriba aqui...">
